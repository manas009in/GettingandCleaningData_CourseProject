...
# Create the final training set by merging yTrain, subjectTrain, and xTrain. Create the final test set by merging the xTest, yTest and subjectTest data. 
# cbind is used as these are only single column data sets.
